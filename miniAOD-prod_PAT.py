...
# with command line options: miniAOD-prod -s PAT --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --runUnscheduled --mc --conditions 110X_mcRun3_2021_realistic_v6 --geometry DB:Extended --era Run3 --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --no_exec
